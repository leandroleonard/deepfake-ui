            ...
            <div className="max-w-4xl mx-auto px-6 py-16 space-y-8">
                ...
                {isPending && (
                    <div className="bg-white border border-gray-200 rounded-2xl shadow-sm p-16 text-center space-y-6">
                        ...
                        <h3 className="text-2xl font-medium" style={{ color: '#000' }}>Processando sua mídia...</h3>
                ...
                {isCompleted && resultData && (
                    <>
                        <div
                            className={`border-2 rounded-2xl p-8 shadow-sm ${resultData.isDeepfake ? 'border-red-200 bg-red-50' : 'border-green-200 bg-green-50'
                                }`}
                        >
                            <div className="flex flex-col md:flex-row items-start gap-6">
                                ...
                                <div className="flex-1">
                                    <h3 className="text-2xl font-semibold mb-2" style={{ color: '#000' }}>
